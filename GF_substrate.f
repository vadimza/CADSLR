      subroutine gf_substrate(z1, z2, rho, xk, eps_sub, 
     $                        GRxx, GRyy, GRzz, GRxz, GRzx, istat) 
                         ...
                         !
                         ! This program uses external subroutine
                         ! to compute Bessel functions
c--------------------------------------------------------------------------
      implicit none         

      complex*16, intent(in) :: eps_sub
      complex*16, intent(out):: GRxx, GRyy, GRzz, GRxz, GRzx
      real*8    , intent(in) :: z1, z2, rho, xk
      integer*4 , intent(out):: istat

      integer*8 N, N1, N2, N3, k
      real*8 y_max, div
c      parameter(y_max=1.0d5, div = 10.0d0)
c      parameter(N=1e5, N1=2*(N/2), N2=2*(N/2), N3=2*(N/2))
...
!      if (rho .ge. rz .and. rho .le. 40) then
!        N1 = 1.0d2
!        N2 = 1.0d4
!        N3 = 1.0d4
!        y_max = 5.0d2
!      end if
!      
!      if (rho .gt. 40 .and. rho .le. 400) then
!        N1 = 1.0d3
!        N2 = 1.0d4
!        N3 = 1.0d5
!        y_max = 5.0d2
!      end if
!      
!      if (rho .gt. 400 .and. rho .le. 1000) then
!        N1 = 3.0d3
!        N2 = 1.0d4
!        N3 = 3.0d5
!        y_max = 3.0d2
!      end if
!      
!      if (rho .gt. 1000 .and. rho .le. 2400) then
!        N1 = 2.0d4
!        N2 = 2.0d4
!        N3 = 5.0d5
!        y_max = 3.0d2
!      end if
!      
!      if (rho .gt. 2400 .and. rho .le. 12000) then
!        N1 = 5.0d5
!        N2 = 1.0d5
!        N3 = 3.0d6
!        y_max = 3.0d2
...
!      if (rho .gt. 12000 .and. rho .le. 24000) then
!        N1 = 2.0d6
!        N2 = 2.0d5
!        N3 = 1.0d6
!        y_max = 2.5d2
...
!      if (rho .ge. rz .and. rho .le. 120) then
!        N1 = 1.0d2
!        N2 = 1.0d4
!        N3 = 1.0d4
!        y_max = 5.0d2
!      end if
!      
!      if (rho .gt. 120 .and. rho .le. 1200) then
!        N1 = 1.0d3
!        N2 = 1.0d4
!        N3 = 1.0d5
!        y_max = 5.0d2
!      end if
!      
!      if (rho .gt. 1200 .and. rho .le. 3000) then
!        N1 = 3.0d3
!        N2 = 1.0d4
!        N3 = 3.0d5
!        y_max = 3.0d2
!      end if
!      
!      if (rho .gt. 3000 .and. rho .le. 7500) then
!        N1 = 2.0d4
!        N2 = 2.0d4
!        N3 = 5.0d5
!        y_max = 3.0d2
!      end if
      ...
      if(z1 .le. rz) then
         write(*,*) 'GF: incorrect parameter [z1<=0]; z1=', z1
         istat = -1
         return
      end if

      if(z2 .le. rz) then
         write(*,*) 'GF: incorrect parameter [z2<=0]; z2=', z2
         istat = -2
         return
      end if
...
!      end if
      ...
      if(dimag(eps_sub). lt. rz) then
         write(*,*) 'GF: incorrect parameter [Im(eps_sub)<0]; eps_sub=',
     $                                                    eps_sub
         istat = -4
         return
      end if
